...
uses IniFiles, ShellAPI, pcnRetConsReciNFe,
  ...
  ACBrDANFCeFortesFr, ACBrPosPrinter, Spin, Data.DB, Vcl.Grids, Vcl.DBGrids,
  Datasnap.DBClient, Vcl.DBCtrls, Vcl.Mask;
...
type
  ...
  TForm1 = class(TForm)
    ...
    gpnlButoes: TGridPanel;
    btnSalvarConfig: TSpeedButton;
    cdsProduto: TClientDataSet;
    cdsProdutonItem: TIntegerField;
    cdsProdutocProd: TStringField;
    cdsProdutocEAN: TStringField;
    cdsProdutoxProd: TStringField;
    cdsProdutoNCM: TStringField;
    cdsProdutoCFOP: TStringField;
    cdsProdutouCom: TStringField;
    cdsProdutoqCom: TFloatField;
    cdsProdutovUnCom: TFloatField;
    cdsProdutovProd: TFloatField;
    cdsProdutovOutro: TFloatField;
    cdsProdutovFrete: TFloatField;
    cdsProdutovDesc: TFloatField;
    cdsProdutoCEST: TStringField;
    cdsProdutoinfAdProd: TStringField;
    cdsProdutoCSOSN: TIntegerField;
    cdsProdutovBC: TFloatField;
    cdsProdutopICMS: TFloatField;
    cdsProdutovICMS: TFloatField;
    cdsProdutoCST: TIntegerField;
    cdsProdutoIPIvBC: TIntegerField;
    cdsProdutopIPI: TFloatField;
    cdsProdutovIPI: TFloatField;
    dsProduto: TDataSource;
    cdsProdutoTotalvProd: TAggregateField;
    cdsProdutoTotalvBC: TAggregateField;
    cdsProdutoTotalvICMS: TAggregateField;
    cdsProdutoTotalvFrete: TAggregateField;
    cdsProdutoTotalvDesc: TAggregateField;
    cdsProdutoTotalvIPI: TAggregateField;
    cdsProdutoTotalvOutro: TAggregateField;
    dsReferencia: TDataSource;
    cdsReferencia: TClientDataSet;
    cdsReferenciarefNFe: TStringField;
    PageControl2: TPageControl;
    tsPrincipal: TTabSheet;
    sbtnEditarGrid: TSpeedButton;
    sbtnExcluirGrid: TSpeedButton;
    sbtnGravarGrid: TSpeedButton;
    pnlCapa: TPanel;
    Label43: TLabel;
    Label44: TLabel;
    Label45: TLabel;
    Label95: TLabel;
    cbDestinodaOperacao: TComboBox;
    edtSerie: TEdit;
    cbFinalidadeNFe: TComboBox;
    DBGrid1: TDBGrid;
    edtrefNFe: TEdit;
    btnGravarReferencia: TButton;
    pnlCapaBase: TPanel;
    Label86: TLabel;
    Label87: TLabel;
    Label88: TLabel;
    ...
    Label93: TLabel;
    Label94: TLabel;
    dbeTotalvProd: TDBEdit;
    dbeTotalvBC: TDBEdit;
    dbeTotalvICMS: TDBEdit;
    dbeTotalvDesc: TDBEdit;
    dbeTotalvFrete: TDBEdit;
    dbeTotalvIPI: TDBEdit;
    dbeTotalvOutros: TDBEdit;
    ValorTotalNota: TEdit;
    pnlGrid: TPanel;
    dbgProduto: TDBGrid;
    ...
    sbtnInserirProduto: TSpeedButton;
    nItem: TEdit;
    cProd: TEdit;
    cEAN: TEdit;
    xProd: TEdit;
    ...
    Label23: TLabel;
    Label24: TLabel;
    sbtnConsultacnpjEmitente: TSpeedButton;
    Label48: TLabel;
    edtEmitCNPJ: TEdit;
    edtEmitIE: TEdit;
    edtEmitRazao: TEdit;
    ...
    Label96: TLabel;
    Label97: TLabel;
    TransportaCNPJCPF: TEdit;
    Label98: TLabel;
    TransportaIE: TEdit;
    Label99: TLabel;
    TransportaxNome: TEdit;
    Label100: TLabel;
    TransportaxEnder: TEdit;
    Label101: TLabel;
    TransportaxMun: TEdit;
    Label102: TLabel;
    TransportaUF: TEdit;
    Label103: TLabel;
    rgConsultaCNPJ: TRadioGroup;
    sbtnConsultacnpjDestinatario: TSpeedButton;
    qVol: TEdit;
    esp: TEdit;
    marca: TEdit;
    nVol: TEdit;
    ...
    Label109: TLabel;
    Label110: TLabel;
    ObsComplementarxCampo: TEdit;
    ObsComplementarxTexto: TEdit;
    ObsFiscoxCampo: TEdit;
    ObsFiscoxTexto: TEdit;
    Label111: TLabel;
    Label112: TLabel;
    Label113: TLabel;
    Label114: TLabel;
    sbtnEnviarNFe: TSpeedButton;
    sbtnStatusNFe: TSpeedButton;
    sbtnSobre: TSpeedButton;
    ...
    procedure sbtnConsultacnpjEmitenteClick(Sender: TObject);
    procedure sbtnConsultacnpjDestinatarioClick(Sender: TObject);
    procedure vProdEnter(Sender: TObject);
    ...
    procedure qComKeyPress(Sender: TObject; var Key: Char);
    procedure vUnComKeyPress(Sender: TObject; var Key: Char);
    procedure vProdKeyPress(Sender: TObject; var Key: Char);
    procedure vOutroKeyPress(Sender: TObject; var Key: Char);
    procedure vFreteKeyPress(Sender: TObject; var Key: Char);
    procedure vDescKeyPress(Sender: TObject; var Key: Char);
    procedure vBCKeyPress(Sender: TObject; var Key: Char);
    procedure pICMSKeyPress(Sender: TObject; var Key: Char);
    procedure vICMSKeyPress(Sender: TObject; var Key: Char);
    procedure IPIvBCKeyPress(Sender: TObject; var Key: Char);
    procedure pIPIKeyPress(Sender: TObject; var Key: Char);
    procedure vIPIKeyPress(Sender: TObject; var Key: Char);
    procedure sbtnSalvarProdutoClick(Sender: TObject);
    procedure sbtnInserirProdutoClick(Sender: TObject);
    procedure vOutroExit(Sender: TObject);
    procedure vFreteExit(Sender: TObject);
    procedure vDescExit(Sender: TObject);
    procedure vBCExit(Sender: TObject);
    procedure pICMSExit(Sender: TObject);
    procedure vICMSExit(Sender: TObject);
    procedure IPIvBCExit(Sender: TObject);
    procedure pIPIExit(Sender: TObject);
    procedure vIPIExit(Sender: TObject);
    procedure sbtnEditarGridClick(Sender: TObject);
    procedure sbtnGravarGridClick(Sender: TObject);
    procedure sbtnExcluirGridClick(Sender: TObject);
    procedure ValorTotalNotaKeyPress(Sender: TObject; var Key: Char);
    procedure btnGravarReferenciaClick(Sender: TObject);
    procedure dbeTotalvProdKeyPress(Sender: TObject; var Key: Char);
    procedure dbeTotalvBCKeyPress(Sender: TObject; var Key: Char);
    procedure dbeTotalvICMSKeyPress(Sender: TObject; var Key: Char);
    procedure dbeTotalvFreteKeyPress(Sender: TObject; var Key: Char);
    procedure dbeTotalvDescKeyPress(Sender: TObject; var Key: Char);
    procedure dbeTotalvIPIKeyPress(Sender: TObject; var Key: Char);
    procedure dbeTotalvOutrosKeyPress(Sender: TObject; var Key: Char);
    procedure sbtnEnviarNFeClick(Sender: TObject);
    procedure sbtnStatusNFeClick(Sender: TObject);
    procedure sbtnSobreClick(Sender: TObject);
    procedure vBCEnter(Sender: TObject);
    procedure IPIvBCEnter(Sender: TObject);
    procedure cEANExit(Sender: TObject);
    procedure uComExit(Sender: TObject);
  ...
  private
    ...
    procedure DesabilitarButoes(Ativo: Boolean);
...
uses
  ...
  ACBrNFeConfiguracoes, U_Principal;
...
begin
  ...
  try
      ...
      Ini.WriteInteger( 'Emitente','Regime'         ,cbRegime.ItemIndex) ;
...
procedure TForm1.IPIvBCEnter(Sender: TObject);
begin
  if vProd.Text <> '' then
    IPIvBC.Text :=  vProd.Text;
end;

procedure TForm1.IPIvBCExit(Sender: TObject);
begin
  if IPIvBC.Text = '' then
    IPIvBC.Text :=  '0';
end;

procedure TForm1.IPIvBCKeyPress(Sender: TObject; var Key: Char);
begin
...
begin
  ...
  try
      ...
      cbRegime.ItemIndex     := Ini.ReadInteger('Emitente','Regime'     ,0);
...
procedure TForm1.sbtnConsultacnpjDestinatarioClick(Sender: TObject);
begin
  F_Principal :=  TF_Principal.Create(Self);
  F_Principal.ShowModal;
end;

procedure TForm1.sbtnConsultacnpjEmitenteClick(Sender: TObject);
begin
  F_Principal :=  TF_Principal.Create(Self);
  F_Principal.ShowModal;
end;

procedure TForm1.sbtnEditarGridClick(Sender: TObject);
begin
  //Editar no Grid
  dbgProduto.Options  :=  [dgEditing,dgAlwaysShowEditor,dgTitles,
                          dgIndicator,dgColumnResize,dgColLines,dgRowLines,
                          dgTabs,dgConfirmDelete,dgCancelOnExit,dgTitleClick,
                          dgTitleHotTrack];
end;

procedure TForm1.sbtnEnviarNFeClick(Sender: TObject);
begin
  //Chamar o Botao Criar e Enviar NFe
  btnCriarEnviar.Click;
end;

procedure TForm1.sbtnExcluirGridClick(Sender: TObject);
begin
  //Deletar Registro
  cdsProduto.Delete;
end;
...
procedure TForm1.sbtnSalvarProdutoClick(Sender: TObject);
begin
  //Inserir no Cliente Data Set
  cdsProduto.Insert;

  cdsProdutonItem.AsInteger     :=  StrToInt(nItem.Text);
  cdsProdutocProd.AsString      :=  cProd.Text;
  cdsProdutocEAN.AsString       :=  cEAN.Text;
  cdsProdutoxProd.AsString      :=  xProd.Text;
  cdsProdutoNCM.AsString        :=  NCM.Text;
  cdsProdutoCFOP.AsString       :=  CFOP.Text;
  cdsProdutouCom.AsString       :=  uCom.Text;
  cdsProdutoqCom.AsFloat        :=  StrToFloat(qCom.Text);
  cdsProdutovUnCom.AsFloat      :=  StrToFloat(vUnCom.Text);
  cdsProdutovProd.AsFloat       :=  StrToFloat(vProd.Text);
  cdsProdutovOutro.AsFloat      :=  StrToFloat(vOutro.Text);
  cdsProdutovFrete.AsFloat      :=  StrToFloat(vFrete.Text);
  cdsProdutovDesc.AsFloat       :=  StrToFloat(vDesc.Text);
  cdsProdutoCEST.AsString       :=  CEST.Text;
  cdsProdutoinfAdProd.AsString  :=  infAdProd.Text;
  cdsProdutoCSOSN.AsInteger     :=  CSOSN.ItemIndex;
  cdsProdutovBC.AsFloat         :=  StrToFloat(vBC.Text);
  cdsProdutopICMS.AsFloat       :=  StrToFloat(pICMS.Text);
  cdsProdutovICMS.AsFloat       :=  StrToFloat(vICMS.Text);
  cdsProdutoCST.AsInteger       :=  CST.ItemIndex;
  cdsProdutoIPIvBC.AsFloat      :=  StrToFloat(IPIvBC.Text);
  cdsProdutopIPI.AsFloat        :=  StrToFloat(pIPI.Text);
  cdsProdutovIPI.AsFloat        :=  StrToFloat(vIPI.Text);

  cdsProduto.Post;

  cdsProduto.IndexFieldNames  :=  'nItem';

  DesabilitarButoes(False);

end;

procedure TForm1.sbtnSobreClick(Sender: TObject);
begin
  //Sobre
  ShowMessage('SystemLogic:'+#13+'Contato:'+#13+'98 9 8260-4909 - Wessel'+#13+
              '98 9 8283-8006 - Emerson');
end;

procedure TForm1.sbtnStatusNFeClick(Sender: TObject);
begin
  //Verificar Status NFe
  ACBrNFe1.WebServices.StatusServico.Executar;

  ShowMessage(ACBrNFe1.WebServices.StatusServico.RetWS +#13+
...
begin
  ...
  //Teste1 :=  EncodeDateTime(2018,03,15,0,0,0,0);//Data 15/03/2018                   ////
  //Teste2 :=  EncodeDateTime(2018,03,30,0,0,0,0);//Data 30/03/2018                   ////
...
procedure TForm1.cEANExit(Sender: TObject);
begin
  if cEAN.Text = '' then
    cEAN.Text :=  GerarEAN13(StrToInt(nItem.Text));
end;

procedure TForm1.CESTKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.CFOPKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.dbeTotalvBCKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.dbeTotalvDescKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.dbeTotalvFreteKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.dbeTotalvICMSKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.dbeTotalvIPIKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.dbeTotalvOutrosKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.dbeTotalvProdKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.DesabilitarButoes(Ativo: Boolean);
begin
  //Desativar Botões
  cProd.Enabled       := Ativo;
  cEAN.Enabled        := Ativo;
  ...
  uCom.Enabled        := Ativo;
  qCom.Enabled        := Ativo;
  vUnCom.Enabled      := Ativo;
  vProd.Enabled       := Ativo;
  vOutro.Enabled      := Ativo;
  vFrete.Enabled      := Ativo;
  vDesc.Enabled       := Ativo;
  CEST.Enabled        := Ativo;
  infAdProd.Enabled   := Ativo;
  CSOSN.Enabled       := Ativo;
  vBC.Enabled         := Ativo;
  pICMS.Enabled       := Ativo;
  vICMS.Enabled       := Ativo;
  CST.Enabled         := Ativo;
  IPIvBC.Enabled      := Ativo;
  pIPI.Enabled        := Ativo;
  vIPI.Enabled        := Ativo;

  sbtnInserirProduto.Enabled  := not Ativo;
  sbtnSalvarProduto.Enabled   := Ativo;

end;

procedure TForm1.vBCEnter(Sender: TObject);
begin
  if vProd.Text <> '' then
    vBC.Text  :=  vProd.Text;
end;

procedure TForm1.vBCExit(Sender: TObject);
begin
  if vBC.Text = '' then
    vBC.Text :=  '0';
end;

procedure TForm1.vBCKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.pICMSExit(Sender: TObject);
begin
  if pICMS.Text = '' then
    pICMS.Text :=  '0';
...
procedure TForm1.pICMSKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.pIPIExit(Sender: TObject);
begin
  if pIPI.Text = '' then
    pIPI.Text :=  '0';
...
procedure TForm1.vICMSExit(Sender: TObject);
begin
  if vICMS.Text = '' then
    vICMS.Text :=  '0';
end;

procedure TForm1.vICMSKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.vIPIExit(Sender: TObject);
begin
  if vIPI.Text = '' then
    vIPI.Text :=  '0';
end;

procedure TForm1.vIPIKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;
...
begin
  ...
  if Application.MessageBox('Deseja Enviar a NFe?','Envio de NFe.', MB_YESNO+MB_ICONQUESTION) = IDNO then
    Abort;
...
begin
 ...
 if Application.MessageBox('Deseja Imprimir o Documento de Inutilização?', 'Inutilização!', MB_YESNO+MB_ICONQUESTION) = IDYES then begin
    ACBrNFe1.InutNFe.LerXML(PathWithDelim(ExtractFileDir(application.ExeName))+'temp.xml');
    ACBrNFe1.InutNFe.xJust  :=  Justificativa;
    ACBrNFe1.ImprimirInutilizacao;
 end;

  pgRespostas.ActivePageIndex := 1;

  //Retorno no ShowMessage
  ShowMessage('Motivo: '+ACBrNFe1.WebServices.Inutilizacao.XMotivo+
              'Codigo do Retorno: '+IntToStr(ACBrNFe1.WebServices.Inutilizacao.cStat));
...
procedure TForm1.sbtnGravarGridClick(Sender: TObject);
begin
  //Mudar opção de editar do dbgProduto
  dbgProduto.Options  :=  [dgTitles,dgIndicator,dgColumnResize,dgColLines,
...
procedure TForm1.btnGravarReferenciaClick(Sender: TObject);
begin
  //Inserir referencia
  cdsReferencia.Insert;
  cdsReferenciarefNFe.AsString  :=  edtrefNFe.Text;
  cdsReferencia.Post;
  edtrefNFe.Clear;
...
begin
  ...
  NotaF.NFe.Ide.natOp     := natOp.Text;
  NotaF.NFe.Ide.indPag    := ipVista;
  NotaF.NFe.Ide.modelo    := 55;
  NotaF.NFe.Ide.serie     := StrToInt(edtSerie.Text);
  NotaF.NFe.Ide.nNF       := StrToInt(NumNFe);
  NotaF.NFe.Ide.dEmi      := Date;
  NotaF.NFe.Ide.dSaiEnt   := Date;
  NotaF.NFe.Ide.hSaiEnt   := Now;
  NotaF.NFe.Ide.tpNF      := TpcnTipoNFe(tpNF.ItemIndex);
  NotaF.NFe.Ide.tpEmis    := TpcnTipoEmissao(cbFormaEmissao.ItemIndex); ;
  NotaF.NFe.Ide.tpAmb     := TpcnTipoAmbiente(rgTipoAmb.ItemIndex);  //Lembre-se de trocar esta variável quando for para ambiente de produção
  ...
  NotaF.NFe.Ide.finNFe    := TpcnFinalidadeNFe(cbFinalidadeNFe.ItemIndex);
  NotaF.NFe.Ide.idDest    := TpcnDestinoOperacao(cbDestinodaOperacao.ItemIndex);
...
//  NotaF.NFe.Ide.xJust  := 'Justificativa Contingencia';
  ...
  cdsReferencia.First;
  while not cdsReferencia.Eof do begin
  //Para NFe referenciada use os campos abaixo
    Referenciada := NotaF.NFe.Ide.NFref.Add;
    Referenciada.refNFe       := cdsReferenciarefNFe.AsString; //NFe Eletronica
...
{$ENDREGION}
  ...
  NotaF.NFe.Emit.IEST              := '';
  NotaF.NFe.Emit.IM                := ''; // Preencher no caso de existir serviços na nota
  NotaF.NFe.Emit.CNAE              := ''; // Verifique na cidade do emissor da NFe se é permitido
                                // a inclusão de serviços na NFe
  NotaF.NFe.Emit.CRT               := TpcnCRT(cbRegime.ItemIndex);// (1-crtSimplesNacional, 2-crtSimplesExcessoReceita, 3-crtRegimeNormal)
...
{$ENDREGION}
  ...
  NotaF.NFe.Dest.indIEDest         := TpcnindIEDest(cbindIEDest.ItemIndex);
...
{$ENDREGION}
  ...
  while not cdsProduto.Eof do begin
    //Adicionando Produtos
      ...
      Produto.Prod.nItem    := cdsProdutonItem.AsInteger; // Número sequencial, para cada item deve ser incrementado
      Produto.Prod.cProd    := cdsProdutocProd.AsString;
      Produto.Prod.cEAN     := cdsProdutocEAN.AsString;
      Produto.Prod.xProd    := cdsProdutoxProd.AsString;
      Produto.Prod.NCM      := cdsProdutoNCM.AsString; // Tabela NCM disponível em  http://www.receita.fazenda.gov.br/Aliquotas/DownloadArqTIPI.htm
      Produto.Prod.EXTIPI   := '';
      Produto.Prod.CFOP     := cdsProdutoCFOP.AsString;
      Produto.Prod.uCom     := cdsProdutouCom.AsString;
      Produto.Prod.qCom     := cdsProdutoqCom.AsFloat;
      Produto.Prod.vUnCom   := cdsProdutovUnCom.AsFloat;
      Produto.Prod.vProd    := cdsProdutovProd.AsFloat;

      Produto.Prod.cEANTrib  := cdsProdutocEAN.AsString;
      Produto.Prod.uTrib     := cdsProdutouCom.AsString;
      Produto.Prod.qTrib     := cdsProdutoqCom.AsFloat;;
      Produto.Prod.vUnTrib   := cdsProdutovUnCom.AsFloat;

      Produto.Prod.vOutro    := cdsProdutovOutro.AsFloat;
      Produto.Prod.vFrete    := cdsProdutovFrete.AsFloat;
      Produto.Prod.vSeg      := 0;
      Produto.Prod.vDesc     := cdsProdutovDesc.AsFloat;

      Produto.Prod.CEST      := cdsProdutoCEST.AsString;

      Produto.infAdProd      := cdsProdutoinfAdProd.AsString;

    {$REGION 'Outras Informações do Produto'}
    ...
    //Campos específicos para venda de medicamentos
    {
      ...
      Medicamento.nLote := '';
      Medicamento.qLote := 0 ;
      Medicamento.dFab  := now ;
      Medicamento.dVal  := now ;
      Medicamento.vPMC  := 0 ;
    }
    ...
    {$ENDREGION}
     ...
     // lei da transparencia nos impostos
      ...
      //Produto.Imposto.ICMS.CST     := cst00;  //Imposto para Empresa do Regime Normal
      Produto.Imposto.ICMS.CSOSN   := TpcnCSOSNIcms(cdsProdutoCSOSN.AsInteger); //Imposto para Empresa do Regime Simples Nacional
      Produto.Imposto.ICMS.orig    := oeNacional;
      Produto.Imposto.ICMS.modBC   := dbiValorOperacao;
      Produto.Imposto.ICMS.vBC     := cdsProdutovBC.AsFloat;
      Produto.Imposto.ICMS.pICMS   := cdsProdutopICMS.AsFloat;
      Produto.Imposto.ICMS.vICMS   := cdsProdutovICMS.AsFloat;
      ...
      {$REGION 'partilha do ICMS e fundo de probreza'}
      ...
      //IPI
      Produto.Imposto.IPI.CST      := TpcnCstIpi(cdsProdutoCST.AsInteger) ;
      ...
      Produto.Imposto.IPI.vBC    := cdsProdutoIPIvBC.AsFloat;
      Produto.Imposto.IPI.qUnid  := 0;
      Produto.Imposto.IPI.vUnid  := 0;
      Produto.Imposto.IPI.pIPI   := cdsProdutopIPI.AsFloat;
      Produto.Imposto.IPI.vIPI   := cdsProdutovIPI.AsFloat;

    {$REGION 'Demais Impostos'}
    {
  ...
  NotaF.NFe.Total.ICMSTot.vBC     := StrToFloat(dbeTotalvBC.Text);
  NotaF.NFe.Total.ICMSTot.vICMS   := StrToFloat(dbeTotalvICMS.Text);
  NotaF.NFe.Total.ICMSTot.vBCST   := 0;
  NotaF.NFe.Total.ICMSTot.vST     := 0;
  NotaF.NFe.Total.ICMSTot.vProd   := StrToFloat(dbeTotalvProd.Text);
  NotaF.NFe.Total.ICMSTot.vFrete  := StrToFloat(dbeTotalvFrete.Text);
  NotaF.NFe.Total.ICMSTot.vSeg    := 0;
  NotaF.NFe.Total.ICMSTot.vDesc   := StrToFloat(dbeTotalvDesc.Text);
  NotaF.NFe.Total.ICMSTot.vII     := 0;
  NotaF.NFe.Total.ICMSTot.vIPI    := StrToFloat(dbeTotalvIPI.Text);
  NotaF.NFe.Total.ICMSTot.vPIS    := 0;
  NotaF.NFe.Total.ICMSTot.vCOFINS := 0;
  NotaF.NFe.Total.ICMSTot.vOutro  := StrToFloat(dbeTotalvOutros.Text);
  NotaF.NFe.Total.ICMSTot.vNF     := StrToFloat(ValorTotalNota.Text);
...

{
  ...
  NotaF.NFe.Transp.modFrete := TpcnModalidadeFrete(modFrete.ItemIndex);
  NotaF.NFe.Transp.Transporta.CNPJCPF  := TransportaCNPJCPF.Text;
  NotaF.NFe.Transp.Transporta.xNome    := TransportaxNome.Text;
  NotaF.NFe.Transp.Transporta.IE       := TransportaIE.Text;
  NotaF.NFe.Transp.Transporta.xEnder   := TransportaxEnder.Text;
  NotaF.NFe.Transp.Transporta.xMun     := TransportaxMun.Text;
  NotaF.NFe.Transp.Transporta.UF       := TransportaUF.Text;
...
//Dados do Reboque
{
  ...
  Volume.qVol  := StrToInt(qVol.Text);
  Volume.esp   := esp.Text;
  Volume.marca := marca.Text;
  Volume.nVol  := nVol.Text;
  Volume.pesoL := StrToFloat(pesoL.Text);
  Volume.pesoB := StrToFloat(pesoB.Text);

{$REGION 'Lacres do volume. Pode ser adicionado vários'}
  //Lacres do volume. Pode ser adicionado vários
{
  ...
  ObsComplementar.xCampo := ObsComplementarxCampo.Text;
  ObsComplementar.xTexto := ObsComplementarxTexto.Text;

  ObsFisco := NotaF.NFe.InfAdic.obsFisco.Add;
  ObsFisco.xCampo := ObsFiscoxCampo.Text;
  ObsFisco.xTexto := ObsFiscoxTexto.Text;
...
// YA. Informações de pagamento
  ...
  if (NotaF.NFe.Ide.finNFe = fnAjuste) or (NotaF.NFe.Ide.finNFe = fnDevolucao) then
  begin
  ...
  begin
    ...
    InfoPgto.vPag   := StrToFloat(ValorTotalNota.Text);
  end;
...
function TForm1.GerarEAN13(Codigo: Integer): string;
...
//      Emit.CNAE              := '6201500'; // Verifique na cidade do emissor da NFe se é permitido
      ...
      //Dados do Cliente
      {
      Dest.CNPJCPF           := '05697633394';
//      Dest.IE                := '687138770110'; //NFC-e não aceita IE
      Dest.ISUF              := '';
      Dest.xNome             := 'WESSEL NIEMYER CARVALHO MARINHO';

      Dest.EnderDest.Fone    := '98982604909';
      Dest.EnderDest.CEP     := 65055845;
      Dest.EnderDest.xLgr    := 'Rua Epitacio Cafeteira';
      Dest.EnderDest.nro     := '90';
      Dest.EnderDest.xCpl    := '';
      Dest.EnderDest.xBairro := 'Vila Brasil';
      Dest.EnderDest.cMun    := 2111300;
      Dest.EnderDest.xMun    := 'São Luis';
...
begin
  ...
  //Retorno em ShowMessage
  ShowMessage('Motivo: '+ACBrNFe1.WebServices.Consulta.XMotivo+
              'Codigo do Retorno: '+IntToStr(ACBrNFe1.WebServices.Consulta.cStat));
...
//  ACBrNFe1.EvnvEvento.EnvEventoNFe.idLote := StrToInt(idLote) ;
  ...
  //Retorno no ShowMessage
  ShowMessage('Motivo: '+ACBrNFe1.WebServices.EnvEvento.XMotivo+
              'Codigo do Retorno: '+IntToStr(ACBrNFe1.WebServices.EnvEvento.cStat));
...
procedure TForm1.qComKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;
...
procedure TForm1.uComExit(Sender: TObject);
begin
  if uCom.Text = '' then
    uCom.Text :=  'UN';
end;

procedure TForm1.ValorTotalNotaKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.vDescExit(Sender: TObject);
begin
  if vDesc.Text = '' then
    vDesc.Text :=  '0';
end;

procedure TForm1.vDescKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.vFreteExit(Sender: TObject);
begin
  if vFrete.Text = '' then
    vFrete.Text :=  '0';
end;

procedure TForm1.vFreteKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.vOutroExit(Sender: TObject);
begin
  if vOutro.Text = '' then
    vOutro.Text :=  '0';
end;

procedure TForm1.vOutroKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;

procedure TForm1.vProdEnter(Sender: TObject);
begin
...
procedure TForm1.vUnComKeyPress(Sender: TObject; var Key: Char);
begin
  if not (Key in ['0'..'9', #8, #13,',',#9]) then
  Key := #0;
end;
...
procedure TForm1.sbtnInserirProdutoClick(Sender: TObject);
begin
  //Incrementar o Numero do Item
  nItem.Text  :=  IntToStr(StrToInt(nItem.Text) + 1);
  //Ativar Butões
  DesabilitarButoes(True);
  //Limpar Edits
  LimparEdits;
  //Setar o Campo Codigo
  cProd.SetFocus;
end;
